...
export function DashboardShell({ backendStatus, snapshot, snapshotTick }: DashboardShellProps) {
  ...
  const content = useMemo(() => {
    switch (activeView) {
      case "standings":
        return <StandingsDashboardView backendStatus={backendStatus} snapshot={snapshot} snapshotTick={snapshotTick} />;
      case "pits":
        return <PitInfoDashboardView backendStatus={backendStatus} snapshot={snapshot} snapshotTick={snapshotTick} />;
      case "sessionInfo":
        return <SessionInfoDashboardView backendStatus={backendStatus} snapshot={snapshot} snapshotTick={snapshotTick} />;
      case "telemetry":
      default:
        return (
